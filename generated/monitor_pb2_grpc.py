...
from generated import monitor_pb2 as monitor__pb2
...
class MonitorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Ping = channel.unary_unary(
                ...
                response_deserializer=monitor__pb2.Pong.FromString,
                _registered_method=True)
        self.GetMetrics = channel.unary_unary(
                '/MonitorService/GetMetrics',
                request_serializer=monitor__pb2.Empty.SerializeToString,
                response_deserializer=monitor__pb2.Metrics.FromString,
                _registered_method=True)
...
def add_MonitorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Ping': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=monitor__pb2.Pong.SerializeToString,
            ),
            'GetMetrics': grpc.unary_unary_rpc_method_handler(
                    servicer.GetMetrics,
                    request_deserializer=monitor__pb2.Empty.FromString,
                    response_serializer=monitor__pb2.Metrics.SerializeToString,
            ),
    }
...
class MonitorService(object):
    ...
    def GetMetrics(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/MonitorService/GetMetrics',
            monitor__pb2.Empty.SerializeToString,
            monitor__pb2.Metrics.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
